export const ProfileDefaultImg = ({width = 43, height = 43}: {width?: number, height?: number}) => {
  return (
    <svg width={width} height={height} viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M8.01562 32.0637C8.01562 27.6367 11.6043 24.0479 16.0312 24.0479H26.7188C31.1457 24.0479 34.7344 27.6367 34.7344 32.0637V33.3996C34.7344 35.6131 32.94 37.4075 30.7266 37.4075H12.0234C9.80998 37.4075 8.01562 35.6131 8.01562 33.3996V32.0637Z"
        fill="#BBBAC5"
      />
    </svg>
  );
