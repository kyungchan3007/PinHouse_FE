...
export const IntegratedHouseType2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width="40"
      height="40"
      ...
      {...props}
    >
      <rect x="25" y="18" width="10" height="17" fill="#96EAD8" />
      <rect x="29" y="20" width="4" height="4" rx="0.5" fill="#D0F5ED" />
      <rect x="29" y="25" width="4" height="4" rx="0.5" fill="#D0F5ED" />
      <path
        ...
        fill="#6EDCC4"
      />
      <rect width="10" height="17" transform="matrix(-1 0 0 1 15 18)" fill="#96EAD8" />
      <rect width="4" height="4" rx="0.5" transform="matrix(-1 0 0 1 11 20)" fill="#D0F5ED" />
      <rect width="4" height="4" rx="0.5" transform="matrix(-1 0 0 1 11 25)" fill="#D0F5ED" />
      <path
        ...
        fill="#6EDCC4"
      />
      <path d="M27 12V36H13V12L19.9555 5L27 12Z" fill="#D0F5ED" />
      <path
      ...
      />
      <path
        d="M19.0537 2.83591C19.6429 2.35579 20.5115 2.3904 21.0606 2.93942L29.0606 10.9394C29.6463 11.5252 29.6463 12.4747 29.0606 13.0605C28.4748 13.6463 27.5252 13.6463 26.9395 13.0605L20 6.12106L13.0606 13.0605C12.4748 13.6463 11.5252 13.6463 10.9395 13.0605C10.3537 12.4747 10.3537 11.5252 10.9395 10.9394L18.9395 2.93942L19.0537 2.83591Z"
        fill="#6EC7B4"
      />
