...
export const PurchaseHouseType2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="25" y="18" width="10" height="17" fill="#DDCBFF" />
      <rect x="29" y="20" width="4" height="4" rx="0.5" fill="#ECE0FF" />
      <rect x="29" y="25" width="4" height="4" rx="0.5" fill="#ECE0FF" />
      <path
        ...
        fill="#C8ABFF"
      />
      <rect width="10" height="17" transform="matrix(-1 0 0 1 15 18)" fill="#DDCBFF" />
      <rect width="4" height="4" rx="0.5" transform="matrix(-1 0 0 1 11 20)" fill="#ECE0FF" />
      <rect width="4" height="4" rx="0.5" transform="matrix(-1 0 0 1 11 25)" fill="#ECE0FF" />
      <path
        ...
        fill="#C8ABFF"
      />
      <path d="M27 12V36H13V12L19.9555 5L27 12Z" fill="#ECE0FF" />
      <path
